...
namespace DIO.Series
{
    class Program
    {
        ...
        static FilmeRepositorio reposito = new FilmeRepositorio();
        ...
        private static void AtualizarFilme()
        {
            ...
            reposito.Atualiza2(indiceFilme, atualizaFilme);
        }
...
private static void InserirFilme()
        {
            ...
            Filme novoFilme = new Filme(id: reposito.ProximoId2(),
                                        genero: (Genero)entradaGenero,
                                        titulo: entradaTitulo,
                                        ano: entradaAno,
                                        descricao: entradaDescricao);

            reposito.Insere2(novoFilme);
        }
